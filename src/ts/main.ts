...
var selectedHSpeedTemp = <HTMLInputElement>document.querySelector('#xspeed');
var selectedHSFTemp = <HTMLInputElement>document.querySelector('#xfactor');
var selectedVSpeedTemp = <HTMLInputElement>document.querySelector('#yspeed');
